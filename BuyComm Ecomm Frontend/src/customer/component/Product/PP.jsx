...
import { filters, singleFilter } from '../../../Data/FiletrData';
...
const PP = () => {
    ...
    const handleFilter = (value, sectionId) => {
        ...
        if (filterValues.length > 0) {
            searchParams.set(sectionId, Array.from(new Set(filterValues)).join(",")); // Remove duplicates
        } else {
    ...
    useEffect(() => {
        ...
        // console.log("hii ", data.minPrice);                                                              
        // console.log("hii ", data.maxPrice);
        ...
        <div className="bg-white">
            <div>
                ...
                <main className="mx-auto max-w-[100%] px-4 sm:px-6 lg:px-8">
                    ...
                    <section aria-labelledby="products-heading" className="pb-8 pt-6">
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            ...
                            <form className="hidden lg:block">
                                <div className='text-lg flex up opacity-50 font-bold'> Filters <FaFilter />
                                </div>
                                {filters.map((section) => (
                    ...
                    <section className='pageniet px-[3.6rem] ' >
                        <div className="px-4 py-5 flex justify-center ">
                            <Pagination count={products.products?.totalPages} variant="outlined" color="secondary" onChange={handlePaginationChange} />
                        </div>
                    </section>
                </main>
            </div>
